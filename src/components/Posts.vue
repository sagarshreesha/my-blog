<template>
    <section class="posts">
        <center><div id="h1h" style="text-align: left; width: 80%;">
            <h2 style="margin: 20px 0px 20px 0px;font-weight:bold !important">Latest Posts</h2>
        </div></center>
  ...
  <div class="card">
    <img src="../assets/ss.svg" class="card-img-top" alt="...">
    <div class="card-body">
